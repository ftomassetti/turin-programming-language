...
public class TypeVariableTypeUsage extends JavaTypeUsage {
    ...
    private String name;
    private List<JavaTypeUsage> bounds;
    private GenericDeclaration genericDeclaration;

    public TypeVariableTypeUsage(GenericDeclaration genericDeclaration, String name, List<JavaTypeUsage> bounds) {
        this.name = name;
