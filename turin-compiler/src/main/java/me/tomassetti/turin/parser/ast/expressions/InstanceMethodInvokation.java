...
public class InstanceMethodInvokation extends Invokable {
    ...
    public TypeUsage calcType() {
        ...
        return subjectType.returnTypeWhenInvokedWith(methodName, actualParams, symbolResolver(), false);
    }
    ...
    protected List<? extends FormalParameter> formalParameters(SymbolResolver resolver) {
        ...
        return typeUsage.asReferenceTypeUsage().getTypeDefinition().getMethodParams(methodName, actualParams, resolver, false);
    }
}
